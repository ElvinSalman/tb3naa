...
const FreeTurbSpinAdj=()=> {
    const { t, i18n } = useTranslation(['']);
    const lang=i18n.language;
    let title=lang==="en"?"Free turbine speed regulator":lang==="ru"?"Регулятор скорости свободной турбины":"Sərbəst turbinin firlanma tezliyi tənzimləyicisi";
    ...
    let home=lang==="en"?"Home":lang==="ru"?"Главная":"Ana səhifə";
        return (
            <div>
                ...
                <iframe width="70%" height="100%" src="https://www.youtube.com/embed/8BoTsR3_YNI" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>
            </div>
        )
}
export default FreeTurbSpinAdj; 
