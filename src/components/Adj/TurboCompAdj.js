...
const TurboCompAdj=()=> {
    ...
    let title=lang==="en"?"Turbocompressor speed regulator":lang==="ru"?"Регулятор скорости турбокомпрессора":"Turbokompressorun firlanma tezliyi tənzimləyicisi";
    ...
    let home=lang==="en"?"Home":lang==="ru"?"Главная":"Ana səhifə";
        return (
            <div>
                ...
                <iframe width="70%" height="100%" src="https://www.youtube.com/embed/SnVLq0mV2oo" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>
            </div>
        )
}
export default TurboCompAdj; 