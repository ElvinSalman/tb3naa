...
const Revenge=()=> {
    ...
    let title=lang==="en"?"Transmission of free turbine speed regulator":lang==="ru"?"Коробка передач регулятора оборотов свободной турбины":"Sərbəst turbinin firlanma tezliyi tənzimləyicisinin intiqalı";
    ...
    let home=lang==="en"?"Home":lang==="ru"?"Главная":"Ana səhifə";
        return (
            <div>
                ...
                <iframe width="70%" height="100%" src="https://www.youtube.com/embed/q9ZExFBiQco" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>
            </div>
        )
}
