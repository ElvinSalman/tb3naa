...
const Control=()=> {
    ...
    let title=lang==="en"?"Monitor system operation":lang==="ru"?"Контроль работы системы":"Sistemin işinə nəzarət";
    ...
    let home=lang==="en"?"Home":lang==="ru"?"Главная":"Ana səhifə";
        return (
            <div>
                ...
                <iframe width="70%" height="100%" src="https://www.youtube.com/embed/YivWHPKARUU" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>
            </div>
        )
}
