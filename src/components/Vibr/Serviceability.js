...
const Serviceability=()=> {
    ...
    let title=lang==="en"?"Swamp control":lang==="ru"?"Контроль соответствия":"Sazlıq nəzarəti";
    ...
    let home=lang==="en"?"Home":lang==="ru"?"Главная":"Ana səhifə";
        return (
            <div>
                ...
                <iframe width="70%" height="100%" src="https://www.youtube.com/embed/cDkkEeY9R8E" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>
            </div>
        )
}
